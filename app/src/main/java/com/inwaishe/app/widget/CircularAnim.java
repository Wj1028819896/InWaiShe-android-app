...
public class CircularAnim {
    ...
    public static class VisibleBuilder {
        ...
        private View mAnimView, mTriggerView, mAnimateViewParent;
        ...
        public VisibleBuilder animateViewParent(View AnimateViewParent) {
            this.mAnimateViewParent = AnimateViewParent;
            return this;
        }

        private Animator.AnimatorListener mAnimatorListener;
        public VisibleBuilder animaterListener(Animator.AnimatorListener animatorListener){
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
            ...
            if (mTriggerView != null) {
                ...
                if(avW == 0|| avH == 0){
                    if(mAnimateViewParent != null){
                        avW = mAnimateViewParent.getWidth();
                        avH = mAnimateViewParent.getHeight();
                    }
                }
                triggerX = Math.min(triggerX, avLX + avW);

                int triggerY = Math.max(avTY, tvCY);
                triggerY = Math.min(triggerY, avTY + avH);
                ...
                if(w == 0|| h == 0){
                    if(mAnimateViewParent != null){
                        w = mAnimateViewParent.getWidth();
                        h = mAnimateViewParent.getHeight();
                    }
                }
